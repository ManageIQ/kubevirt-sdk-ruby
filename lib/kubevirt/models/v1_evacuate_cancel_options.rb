...
module Kubevirt
  ...
  class V1EvacuateCancelOptions < ApiModelBase
    ...
    # @param [Object] evacuation_node_name Value to be assigned
    def evacuation_node_name=(evacuation_node_name)
      if evacuation_node_name.nil?
        fail ArgumentError, 'evacuation_node_name cannot be nil'
      end

      @evacuation_node_name = evacuation_node_name
    end
