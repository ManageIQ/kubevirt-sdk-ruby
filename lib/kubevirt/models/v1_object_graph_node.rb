...
module Kubevirt
  ...
  class V1ObjectGraphNode < ApiModelBase
    ...
    # @param [Object] object_reference Value to be assigned
    def object_reference=(object_reference)
      if object_reference.nil?
        fail ArgumentError, 'object_reference cannot be nil'
      end
